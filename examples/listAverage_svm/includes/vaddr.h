...
__attribute__((noinline)) int readVirt(unsigned *vaddr, unsigned * l1_pagetable){
        unsigned *paddr = virt2phys(vaddr, l1_pagetable);
        return *paddr;
}

__attribute__((noinline)) void setupPageTables(unsigned * l1_pagetable, unsigned *paddr_start, unsigned *page_start){
